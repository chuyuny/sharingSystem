...
module.exports = {
    ...
    uploadPhoto: function (req, dirName, callback) {
        //上传文件
        // parse a file upload
        // var str = 'D:\\myWeb\\myWeb\\src\\assets\\'
        // var str = 'D:\\myWeb\\'
        // var str = 'C:\\Users\\cy\\OneDrive\\dissertation\\service\\resource\\'
        var str = 'C:\\Users\\cy\\OneDrive\\dissertation\\service\\myWeb\\assets\\';
        // var str = 'C:\\Users\\cy\\OneDrive\\dissertation\\service\\resource\\'
        var form = new formidable.IncomingForm();
        if (dirName === 'user-img') {
            var str1 = 'C:\\Users\\cy\\OneDrive\\dissertation\\service\\myWeb\\';
            var filePath = (req.query.userPicture.split('/')).join('\\');
            var oldFile = path.join(str1, filePath);
            fs.unlink(oldFile, function (e) {
            });
        }
        form.uploadDir = path.join(str, dirName);
        //保留文件扩展名
        ...
        form.parse(req, function (err, fields, files) {
            ...
            var newPath = path.join(str, dirName, newName);
            //修改文件的名字
